...
#include "internal/Source/JSONDefs.h"  //for typedefs of functions, strings, and nodes
...
*/
    ...
    #endif
    #include "internal/Source/JSONNode.h"  //not used in this file, but libjson.h should be the only file required to use it embedded
    #include "internal/Source/JSONWorker.h"
    #include "internal/Source/JSONValidator.h"
    #include "internal/Source/JSONStream.h"
    #include "internal/Source/JSONPreparse.h"
    #ifdef JSON_EXPOSE_BASE64
	   #include "internal/Source/JSON_Base64.h"
    #endif
